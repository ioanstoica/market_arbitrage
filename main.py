...
# print(
#     "Am filtrat ofertele care au mai mult de 100 de vizualizari. Au ramas "
#     + str(len(oferte_vizualizate))
#     + " oferte."
# )
...
#     print(
#         "Cautam oferte similare pe Aliexpress pentru oferta cu id-ul "
#         + oferta_olx.id
#         + "..."
#     )
#     oferte_aliexpress = []
